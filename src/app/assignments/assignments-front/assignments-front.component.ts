...
@Component({
  selector: 'app-assignments-front',
  templateUrl: './assignments-front.component.html',
  styleUrls: ['./assignments-front.component.css']
})
export class AssignmentsFrontComponent implements OnInit {
